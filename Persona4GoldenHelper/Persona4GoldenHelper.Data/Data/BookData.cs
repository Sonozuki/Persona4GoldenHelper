...
namespace Persona4GoldenHelper.Data.Data
{
    ...
    public static class BookData
    {
        ...
        {
            new BookOrder() {
                BookName = "The Lovely Man"
            },
            new BookOrder() {
                BookName = "Forever Macho"
            },
            new BookOrder() {
                BookName = "Man of History"
            },
            new BookOrder() {
                BookName = "Man-God"
            },
            new BookOrder() {
                BookName = "Farewell to Man"
            },
            new BookOrder() {
                BookName = "Off Today"
            },
            new BookOrder() {
                BookName = "Short on Cash"
            },
            new BookOrder() {
                BookName = "Changing Careers"
            },
            new BookOrder() {
                BookName = "Sensei's Friends"
            },
            new BookOrder() {
                BookName = "The Final Lesson"
            },
            new BookOrder() {
                BookName = "The O-Cha Way"
            },
            new BookOrder() {
                BookName = "The Gentle Way"
            },
            new BookOrder() {
                BookName = "The Divine Way"
            },
            new BookOrder() {
                BookName = "The Ramen Way"
            },
            new BookOrder() {
                BookName = "The Punk's Way"
            },
            new BookOrder() {
                BookName = "Witch Detective"
            },
            new BookOrder() {
                BookName = "Poly-land"
            },
            new BookOrder() {
                BookName = "Guide to Pests"
            },
            new BookOrder() {
                BookName = "Picross Rules!"
            },
            new BookOrder() {
                BookName = "Who Am I?"
            },
            new BookOrder() {
                BookName = "Expert Study Methods"
            },
            new BookOrder() {
                BookName = "English Made Easy"
            },
            new BookOrder() {
                BookName = "100 Ghost Stories"
            },
            new BookOrder() {
                BookName = "Office Work Manual"
            },
            new BookOrder() {
                BookName = "Easy Origami"
            },
            new BookOrder() {
                BookName = "Food Fight!"
            },
            new BookOrder() {
                BookName = "Beginner Fishing"
            },
            new BookOrder() {
                BookName = "Expert Fishing"
            },
            new BookOrder() {
                BookName = "Catching Bugs"
            },
            new BookOrder() {
                BookName = "World-Class Bugs"
            },
            new BookOrder() {
                BookName = "Home Gardening"
            },
            new BookOrder() {
                BookName = "Hyperspeed Reading"
            }
        };
    }
}
